...
```text
                 ...
                 +%%#@%*+*#*%@@@@@#=                  Focus     AI-enabled SaaS · product engineering
              .:=+---:-=+*#*#%@@@@@@+                 Uptime    shipping since 2021
            .=-*+:..   ..:--=+#%@@@@@=
            *%=-..     ..:::--=+#%@@@@.               - Stack ─────────────────────────────────────
            =#--:.    ...:::--=+**%@@@.               Frontend  React · TypeScript · JavaScript
             ##-:::::::::::-=+***#%@@#                Backend   Node.js · PostgreSQL · SQL
             #@-=+**%#+=-=*%@@@@@%%@@%                Also      Python · C
             #*::==+**=-.=%%#####*#@@%                Delivery  features · debugging · QA
             -+:.  ......=#*=====+#%@#
             .--......:..-#*=---=*#%@*                - Interface ─────────────────────────────────
              .:::.:=-:-:+###+=+*###+                 Taste     quiet motion · tactile software
            .-=+---==-=##%@@%#**#%%#*+=:              Signal    software · music · design
          =%@@@@=:--+=++*+#%%%#*##@@@@@@%:            Human     English (native) · German (B2)
         .@@@@@@%---:::-=+*##**#%%@@@@@@@%            Study     Digital Business + Software Engineering
         *@@@@@@@=--::::-===+*#%%%@@@@@@@@=
        .@@@@@@@@-:-=:::---+*#%%%%@@@@@@@@-           - Now ───────────────────────────────────────
